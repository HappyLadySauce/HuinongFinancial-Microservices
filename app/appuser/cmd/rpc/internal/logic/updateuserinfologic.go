...
func (l *UpdateUserInfoLogic) UpdateUserInfo(in *appuser.UpdateUserInfoReq) (*appuser.UpdateUserInfoResp, error) {
	l.Infof("更新用户信息请求, user_id: %d", in.UserInfo.Id)
	...
	existUser.Occupation = in.UserInfo.Occupation
	existUser.Address = in.UserInfo.Address
	existUser.Income = in.UserInfo.Income
