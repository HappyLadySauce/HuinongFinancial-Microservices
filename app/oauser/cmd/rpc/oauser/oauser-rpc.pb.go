...
type UserInfo struct {
	...
	Role          string                 `protobuf:"bytes,7,opt,name=role,proto3" json:"role,omitempty"`                              // 管理员(admin)/普通操作员(operator)
...
const file_oauser_rpc_proto_rawDesc = "" +
	"\n" +
	"\x10oauser-rpc.proto\x12\x06oauser\"\xf4\x01\n" +
	"\bUserInfo\x12\x0e\n" +
	...
	"\tuser_info\x18\x03 \x01(\v2\x10.oauser.UserInfoR\buserInfo\"B\n" +
	"\x11UpdateUserInfoReq\x12-\n" +
	"\tuser_info\x18\x01 \x01(\v2\x10.oauser.UserInfoR\buserInfo\"q\n" +
	...
	"\bRegister\x12\x13.oauser.RegisterReq\x1a\x14.oauser.RegisterResp\x12/\n" +
	"\x06Logout\x12\x11.oauser.LogoutReq\x1a\x12.oauser.LogoutResp\x12G\n" +
	"\x0eChangePassword\x12\x19.oauser.ChangePasswordReq\x1a\x1a.oauser.ChangePasswordRespB\n" +
...
var file_oauser_rpc_proto_depIdxs = []int32{
	...
	0,  // 1: oauser.UpdateUserInfoReq.user_info:type_name -> oauser.UserInfo
